...
const invoice = {
  ...
  detallePago: [
    {
      mtoCuotaPago: "50.00",
      fecCuotaPago: "2021-09-10",
      tipMonedaCuotaPago: "PEN"
    },
    {
      mtoCuotaPago: "68.00",
      fecCuotaPago: "2021-09-20",
      tipMonedaCuotaPago: "PEN"
    }
  ]
}
...
const {cabecera, detalle, tributos, leyendas, datoPago, detallePago} = invoice;
console.log();
...
console.log();
console.log(quoteToDoubleQuote(JSON.stringify({detallePago})));
